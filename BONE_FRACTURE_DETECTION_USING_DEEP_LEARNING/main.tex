...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{System_Arch.jpg} % Placeholder for Accuracy/Loss Plot
    \caption{Training and Validation Accuracy/Loss Plots for ViT Model}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{UI_UX.png} % Placeholder for Dashboard Screenshot
    \caption{Visual Representation of the Medical AI Dashboard}
