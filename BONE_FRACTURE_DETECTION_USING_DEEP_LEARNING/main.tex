...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{propsed_system.png} % Most relevant available image for results placeholder
    \caption{AI Model Training and Validation Accuracy/Loss Analysis}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{flow_chart.png} % High-level flow instead of legacy battery UI
    \caption{Visual Workflow of the Medical AI Dashboard and Inference System}
